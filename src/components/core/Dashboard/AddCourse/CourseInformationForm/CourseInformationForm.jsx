    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea className="form-style resize-x-none min-h-[130px] w-full" id="courseShortDesc" placeholder='Enter Description' {...register("courseShortDesc", { required: true })} />
                {
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea id="courseBenefits" placeholder='Enter the benefits of the course' className="form-style resize-x-none min-h-[130px] w-full"
