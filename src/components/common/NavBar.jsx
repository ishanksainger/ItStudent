      ...
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        <Link to="/">
          <img
            ...
            alt="Logo"
            loading="lazy"
            className=" w-[110px] sm:w-[160px] sm:h-[32px]"
          />
        </Link>
        ...
        <div className="flex">
          ...
          <div className="flex items-center gap-x-2 sm:gap-x-4 md:hidden">
            ...
            {token === null && (
              <Link to="/login">
                <button
                  className="rounded-[8px]  border border-richblack-700 bg-richblack-800 px-[8px] py-[4px] sm:px-[12px] sm:py-[8px] text-richblack-100"
                  onClick={closeMenu}
                >
                  Log in
                </button>
        ...
        {isMenuOpen && (
          <div
            className={`md:hidden fixed z-50 top-14 left-0 right-0 bg-richblack-800 py-2 transform ${
              isMenuOpen ? "mobile-menu-animation" : ""
                ...
                <li key={index}>
                  {link.title === "Catalog" ? (
                    <div
                      ...
                      <BsChevronDown />
                      <div
                        className={`absolute left-[50%] top-0 z-50 w-[300px] translate-x-[-50%]
              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  ...
                  >
                    ...
                    <BsChevronDown />
                    <div
                      className="invisible absolute left-[50%] top-[50%] z-[1000] flex w-[200px] translate-x-[-50%]
